...
#define __GMP_CFLAGS "-arch arm64 -isysroot /Applications/Xcode_15.4.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk -target arm64-apple-macos11.0 -mmacosx-version-min=11.0"
